  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-28 pt-4 px-4">
      <div className="max-w-md mx-auto space-y-4">
        ...
        {/* ================= 1. HEADER PROFIL ================= */}
        <div className="bg-white p-5 border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            {profile?.avatar ? (
              <img src={profile.avatar} alt={profile.name} className="w-14 h-14 object-cover border-2 border-sky-100 shadow-xs" />
            ) : (
              <div className="w-14 h-14 bg-sky-50 text-[#0d5c91] flex items-center justify-center font-bold text-xl border-2 border-sky-100 shadow-xs">
            ...
            <div>
              ...
              <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 px-2 py-0.5 mt-1">
                ✓ Member Islami.or.id
              </span>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#0d5c91] to-sky-900 text-white p-5 shadow-lg space-y-3 relative overflow-hidden">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs bg-white/10 px-2.5 py-1 font-bold text-sky-100">{levelInfo.name}</span>
          </div>
          <div>
        ...
        <div className="bg-white p-4 border border-slate-200/80 shadow-xs space-y-2.5">
          ...
          <div className="w-full bg-slate-100 h-2.5 overflow-hidden shadow-inner">
        ...
        {/* ================= 4. NOMOR WHATSAPP ================= */}
        <div className="bg-white p-4 border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-sky-50 text-[#0d5c91] flex items-center justify-center">
          ...
          <button
            ...
            className="text-xs font-bold text-[#0d5c91] hover:underline bg-sky-50 hover:bg-sky-100 px-3 py-1.5 transition cursor-pointer"
          >
            Ubah
          </button>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 shadow-xs overflow-hidden divide-y divide-slate-100">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-sm p-5 space-y-4 shadow-2xl border border-slate-200 text-left">
            ...
            <form onSubmit={handleUpdatePhone} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-300 px-3.5 py-2.5 text-sm font-semibold text-slate-900 focus:outline-[#0d5c91]"
                />
              </div>
              ...
              <button
                ...
                className="w-full bg-[#0d5c91] hover:bg-sky-900 text-white font-bold py-3 text-xs uppercase tracking-wider transition cursor-pointer disabled:bg-slate-300 shadow-sm"
              >
