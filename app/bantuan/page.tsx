      ...
      <div className="w-full max-w-md mx-auto bg-white border border-slate-200 shadow-sm p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-3.5">
          ...
          <div className="border border-slate-200 p-3.5 space-y-1.5 hover:border-sky-500 transition-colors">
            <h3 className="font-bold text-slate-900 text-sm sm:text-base">Kendala Akun & Akses</h3>
          ...
          <div className="border border-slate-200 p-3.5 space-y-1.5 hover:border-sky-500 transition-colors">
            <h3 className="font-bold text-slate-900 text-sm sm:text-base">Informasi Platform</h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="border border-slate-200 p-3.5 space-y-1.5 hover:border-sky-500 transition-colors">
            <h3 className="font-bold text-slate-900 text-sm sm:text-base">Status Aktivitas</h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
