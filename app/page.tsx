...
//
// Itu membuat homepage selalu dirender ulang.
//
// Untuk homepage publik berbasis Sanity, ISR jauh lebih tepat.
//
// 300 detik = maksimal sekitar 5 menit sebelum halaman dapat diregenerasi.
// ============================================================================
...
// Homepage hanya membaca konten publik.
//
// SANITY_API_TOKEN tidak diperlukan di sini.
// Ini juga mencegah homepage tanpa sengaja mengambil konten draft/private.
//
// useCdn false dipakai bersama ISR agar regenerasi mengambil data terbaru
// dari Sanity ketika halaman diregenerasi.
//
const serverClient =
  createClient({
    projectId,
...
export default async function HomePage() {
  ...
  // Hindari karakter "<" mentah masuk ke script JSON-LD.
  const jsonLd =
    JSON.stringify(
      structuredData
    ).replace(
